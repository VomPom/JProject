...
/*******************************************************
 *
 * Created by juliswang on 2022/02/09 14:41 
 *
 * Description : 
 *
 *
...
public class MyNativeRender {
    ...
    public static final int SAMPLE_TYPE_KEY_TEXT_RENDER         = SAMPLE_TYPE + 6;
    public static final int SAMPLE_TYPE_COORD_SYSTEM            = SAMPLE_TYPE + 7;
    public static final int SAMPLE_TYPE_TRANS_FEEDBACK          = SAMPLE_TYPE + 8;
    public static final int SAMPLE_TYPE_BASIC_LIGHTING          = SAMPLE_TYPE + 9;
    ...
    public static final int SAMPLE_TYPE_KEY_BEATING_HEART       = SAMPLE_TYPE + 33;
    ...
    public native void nativeSetParamsFloat(int paramType, float value0, float value1);

    public native void nativeUpdateTransformMatrix(float rotateX, float rotateY, float scaleX, float scaleY);

    public native void nativeSetImageData(int format, int width, int height, byte[] bytes);

    public native void nativeSetImageDataWithIndex(int index, int format, int width, int height, byte[] bytes);

    public native void nativeSetAudioData(short[] audioData);
