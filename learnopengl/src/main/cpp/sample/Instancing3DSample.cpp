...
void Instancing3DSample::Draw(int screenW, int screenH) {
    ...
    UpdateMatrix(m_MVPMatrix, m_ModelMatrix, m_AngleX + 10, m_AngleY + 10, m_ScaleX > m_ScaleY ? m_ScaleY : m_ScaleX,
...
void Instancing3DSample::UpdateMatrix(glm::mat4 &mvpMatrix, glm::mat4 &modelMatrix, int angleXRotate, int angleYRotate,
    ...
    //Model = include.glm::translate(Model, transVec3);
