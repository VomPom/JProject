...
#define SAMPLE_TYPE_KEY_TEXT_RENDER             SAMPLE_TYPE + 6
#define SAMPLE_TYPE_KEY_COORD_SYSTEM            SAMPLE_TYPE + 7
#define SAMPLE_TYPE_KEY_TRANSFORM_FEEDBACK      SAMPLE_TYPE + 8
#define SAMPLE_TYPE_KEY_BASIC_LIGHTING          SAMPLE_TYPE + 9
...
#define SAMPLE_TYPE_KEY_BEATING_HEART           SAMPLE_TYPE + 33
