...
//    m_pShader->setVec3("lightPos", include.glm::vec3(0, 0, m_pModel->GetMaxViewDistance()));
//    m_pShader->setVec3("lightColor", include.glm::vec3(1.0f, 1.0f, 1.0f));
//    m_pShader->setVec3("viewPos", include.glm::vec3(0, 0, m_pModel->GetMaxViewDistance()));
...
//}
//
//void Model3DSample::UpdateMVPMatrix(include.glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
...
//
//    // Projection matrix
//    //include.glm::mat4 Projection = include.glm::ortho(-ratio, ratio, -1.0f, 1.0f, 0.1f, 100.0f);
//    include.glm::mat4 Projection = include.glm::frustum(-ratio, ratio, -1.0f, 1.0f, 1.0f, m_pModel->GetMaxViewDistance() * 4);
//    //include.glm::mat4 Projection = include.glm::perspective(45.0f,ratio, 0.1f,100.f);
//
//    // View matrix
//    include.glm::mat4 View = include.glm::lookAt(
//            include.glm::vec3(0, 0, m_pModel->GetMaxViewDistance() * 1.8f), // Camera is at (0,0,1), in World Space
//            include.glm::vec3(0, 0, 0), // and looks at the origin
//            include.glm::vec3(0, 1, 0)  // Head is up (set to 0,-1,0 to look upside-down)
//    );
//
//    // Model matrix
//    include.glm::mat4 Model = include.glm::mat4(1.0f);
//    Model = include.glm::scale(Model, include.glm::vec3(m_ScaleX, m_ScaleY, 1.0f));
//    Model = include.glm::rotate(Model, radiansX, include.glm::vec3(1.0f, 0.0f, 0.0f));
//    Model = include.glm::rotate(Model, radiansY, include.glm::vec3(0.0f, 1.0f, 0.0f));
//    Model = include.glm::translate(Model, -m_pModel->GetAdjustModelPosVec());
//    m_ModelMatrix = Model;
