package wang.julis.jproject.example.source.koin.scope2
 ...
 *
 * @Description 基于 Koin 的设计，实现其核心模块
 *
 *     实现下面的注册并能成功，获取对应实例的值能与其他 scope(rootScope)区分开来
 *     使用 @DslMarker 限制DSL调用的上下文，并且通过代码颜色区分
 *
 *     startKoin {
 *          modules(
 *             module {
