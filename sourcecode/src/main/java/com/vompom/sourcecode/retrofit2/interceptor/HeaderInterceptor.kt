package com.vompom.sourcecode.retrofit2.interceptor


import com.vompom.sourcecode.retrofit2.manager.CookiesManager
...
class HeaderInterceptor : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (!host.isNullOrEmpty() && (url.contains(COLLECTION_WEBSITE)
            ...
            Logger.e("HeaderInterceptor:cookies:$cookies")
