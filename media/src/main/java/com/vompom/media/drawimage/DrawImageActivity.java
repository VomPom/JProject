package com.vompom.media.drawimage;
...
import wang.julis.jwbase.utils.BitmapUtils;
...
public class DrawImageActivity extends BaseActivity {
    ...
    protected void initData() {
        bitmap = BitmapUtils.getBitmapFromAssets(this, "julis.png");
        bitmap2 = BitmapUtils.getBitmapFromAssets(this, "sign.png");
    }
