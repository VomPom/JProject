...
/**
 * Copy from: <a href="https://github.com/google/grafika"></a>
 * <p>
 * <p>
 ...
 */
public class PlayerWithoutAudio {
     ...
     * @throws IOException
     */
    public PlayerWithoutAudio(File sourceFile, Surface outputSurface, FrameCallback frameCallback)
            throws IOException {
    ...
    public static class PlayTask implements Runnable {
        ...
        private PlayerWithoutAudio mPlayer;
         ...
         */
        public PlayTask(PlayerWithoutAudio player, PlayerFeedback feedback) {
            mPlayer = player;
            mFeedback = feedback;
