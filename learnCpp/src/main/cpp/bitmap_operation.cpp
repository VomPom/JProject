...
Java_wang_julis_learncpp_bitmap_BitmapOps_rotateBitmap(JNIEnv *env, jobject, jobject bitmap) {
    LOGD("rotate bitmap");
...
extern "C"
JNIEXPORT jobject JNICALL Java_wang_julis_learncpp_bitmap_BitmapOps_convertBitmap
...
extern "C"
JNIEXPORT jobject JNICALL
Java_wang_julis_learncpp_bitmap_BitmapOps_mirrorBitmap(JNIEnv *env, jobject thiz, jobject bitmap) {
    LOGD("mirror bitmap");
    AndroidBitmapInfo bitmapInfo;
    int ret;
    if ((ret = AndroidBitmap_getInfo(env, bitmap, &bitmapInfo)) < 0) {
